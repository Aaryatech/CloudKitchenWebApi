...
public class FranchiseDataNew {
	...
	public String toString() {
		return "FranchiseDataNew [frConfigId=" + frConfigId + ", frId=" + frId + ", frType=" + frType + ", frName="
				...
				+ toLongitude + ", kmAreaCovered=" + kmAreaCovered + ", compId=" + compId + ", isCourier=" + isCourier
