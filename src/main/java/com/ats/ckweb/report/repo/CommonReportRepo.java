...
//public interface CommonReportRepo extends JpaRepository<JSONObject, Integer> {
//
//	@Query(value="SELECT\n" + 
//			"	head.order_id,\n" + 
//			"    head.order_no,\n" + 
...
//	public List<JSONObject> getOrderReportDateWise(@Param("fromDate") String fromDate, @Param("toDate") String toDate,
...
//	public List<JSONObject> getOrderReportBtwenDate(@Param("fromDate") String fromDate, @Param("toDate") String toDate,
//			@Param("status") int status);
//}
