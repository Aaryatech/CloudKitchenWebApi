...
public class EmailUtility {
	...
	public static Info sendEmailContactUs(String senderEmail, String senderPassword, String recipientEmail,
			String mailsubject, String defUsrName) {
		...
		try {
			...
			try {
				...
				mimeMessage.setRecipients(Message.RecipientType.TO, InternetAddress.parse(address));
				mimeMessage.setSubject(subject);
				mimeMessage.setContent(defUsrName, "text/html");
	...
	// OTP EMAIL
	public static Info sendEmailOTP1(String senderEmail, String senderPassword, String recipientEmail,
			...
			String sms = restTemplate
					.getForObject(
							"https://smsapi.24x7sms.com/api_2.0/SendSMS.aspx?APIKEY=pJMAaVPuGbh&MobileNo=" + mob
									+ "&SenderID=MDVDRY&Message=" + message + "&ServiceName=TEMPLATE_BASED",
							String.class);
...
//						 "Your OTP to change your password is ("+OTP+").";
			...
			for (int i = 0; i < mob.size(); i++) {
				...
				try {
					// NA- sms =
					// restTemplate.getForObject("https://smsapi.24x7sms.com/api_2.0/SendSMS.aspx?APIKEY=pJMAaVPuGbh&MobileNo="+mob.get(i)+"&SenderID=MADHVI&Message="+message+"&ServiceName=TEMPLATE_BASED",
					// String.class);
				} catch (Exception e) {
	...
	public static Info sendOrderEmail1(String senderEmail, String senderPassword, String frEmail, String mailsubject,
			String mailText) {
...
//						 "Your OTP to change your password is ("+OTP+").";
			...
			// NA- String sms =
			// restTemplate.getForObject("https://smsapi.24x7sms.com/api_2.0/SendSMS.aspx?APIKEY=pJMAaVPuGbh&MobileNo="+mob+"&SenderID=MADHVI&Message="+f+"&ServiceName=TEMPLATE_BASED",
			// String.class);
