...
public class EmailUtility {
	...
	public static Info sendOtp(String OTP, String phoneNo) {
		...
		String sms = restTemplate.getForObject("https://smsapi.24x7sms.com/api_2.0/SendSMS.aspx?APIKEY=pJMAaVPuGbh&MobileNo="+mob+"&SenderID=MDVDRY&Message="+message+"&ServiceName=TEMPLATE_BASED", String.class);
