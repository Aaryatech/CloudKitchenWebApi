...
public interface FrItemStockRepo extends JpaRepository<FrItemStock ,Integer>{
	 ...
	 @Query(value = "SELECT\r\n" + 
		...
		List<FrItemStock> getFrCurrStock(@Param("frId") int frId, @Param("fromDate") String fromDate, @Param("toDate") String toDate,
