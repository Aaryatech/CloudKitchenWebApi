...
public interface CkDeliveryChargesRepo extends JpaRepository<CkDeliveryCharges, Integer> {
	...
	@Query(value = "SELECT\r\n" + 
			...
			"    WHERE\r\n" + 
			"        d.del_status = 0 AND :km >= d.min_km AND :km < d.max_km\r\n" + 
			") t1\r\n" + 
			"LEFT JOIN(\r\n" + 
			"    SELECT 1 AS flag,\r\n" + 
			...
			"        t_setting_new s\r\n" + 
			"    WHERE\r\n" + 
			"        s.del_status = 0 AND s.setting_key = 'ck_min_order_amt'\r\n" + 
			") t2\r\n" + 
			"ON\r\n" + 
			"    t1.flag = t2.flag\r\n" + 
			"LEFT JOIN(\r\n" + 
			...
			"        t_setting_new s\r\n" + 
			"    WHERE\r\n" + 
			"        s.del_status = 0 AND s.setting_key = 'ck_free_delivery_min_order_amt'\r\n" + 
			") t3\r\n" + 
			"ON\r\n" + 
