...
public interface OfferHeaderRepo extends JpaRepository<OfferHeader, Integer> {
	...
	@Transactional
	@Modifying
	@Query(value="UPDATE mn_offer_header SET offer_type=:type, ex_int1=:billType WHERE offer_id =:offerId",nativeQuery=true)
	public int updateBillWiseOfferType(@Param("offerId") int offerId,@Param("type") int type,@Param("billType") int billType);
